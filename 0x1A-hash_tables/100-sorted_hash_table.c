...
/**
 * shash_table_create -this Fuction creates a sorted hash table.
...
/**
 * set_spair -this Fuction mallocs a key/value pair to the sorted hash table.
...
/**
 * set_spair_only-this Fuction (no collision) set key:value pair to first
 * array element
...
/**
 * set_spair_front -this Fuction sets key:value pair node to front
 * of given index's list.
 * @ht: pointer to the sorted hash table.
 * @key: the key, a string that cannot be empty.
 * @value: the value associated with the key, can be an empty string.
 * @index: the key's index.
...
/**
 * slist_set_first -this Fuction sets the first addition to the sorted list.
 * @ht: pointer to the sorted hash table.
...
/**
 * slist_set -this Fuction sets a new node before the given old node.
 * @ht: pointer to the sorted hash table.
...
/**
 * slist_set_end -this Fuction sets a node at the end of the sorted list
 * @ht: pointer to the sorted hash table.
...
/**
 * shash_table_set -this Fuction  adds or updates an element to the sorted hash table.
 * @ht: pointer to the sorted hash table.
 * @key: the key, a string that cannot be empty.
 * @value: the value associated with the key, can be an empty string.
 *
...
/**
 * shash_table_get -this Fuction retrieves a value associated with a key.
...
/**
 * shash_table_print -this Fuction prints key/value pairs in sorted hash table order.
...
/**
 * shash_table_print_rev -thos Fuction  prints sorted key/value pairs in reverse.
 * @ht: the sorted hash table.
 */
...
/**
 * shash_table_delete -this Fuction  deletes a sorted hash table
 * @ht: the sorted hash table.
 */
